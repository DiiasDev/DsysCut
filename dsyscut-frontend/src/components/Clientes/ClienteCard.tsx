    ...
    return (
        ...
        >
            <div className="flex items-center gap-4">
                ...
                <div>
                    <div className="font-bold text-lg" style={{ color: "var(--color-text)" }}>{cliente.nome}</div>
                    {cliente.whatsapp && (
                        <div className="text-xs font-mono" style={{ color: "var(--color-text-secondary)" }}>{cliente.whatsapp}</div>
                    )}
                    <span
                        className="inline-block px-2 py-0.5 rounded-full text-xs font-semibold mt-1"
                        style={{
                            background: cliente.mensalAtivo ? "var(--color-success)" : "var(--color-error)",
            ...
            <button
                ...
                style={{
                    background: cliente.mensalAtivo ? "var(--color-error)" : "var(--color-success)",
                    color: "var(--color-bg-card)"
                }}
            >
            ...
            {tipo === 'mensal' && 
                ...
                <div className="text-sm mt-1" style={{ color: "var(--color-text-secondary)" }}>
                    <span className="font-semibold" style={{ color: "var(--color-accent)" }}>{cliente.cortesRestantes}</span> / {cliente.totalCortes} cortes restantes
                </div>
            )}
